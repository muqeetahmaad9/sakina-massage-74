// Full list of countries/territories with ISO 3166-1 alpha-2 code, French display name,
// and international dialing code. Flags are derived from the ISO code at render time
// (via Unicode regional indicator symbols) rather than stored, to keep this list compact.
...
export const countries: CountryData[] = [
  ...
  { code: 'SB', name: 'Salomon (Îles)', dial: '+677' },
  ...
  { code: 'TF', name: 'Terres Australes Françaises', dial: '+262' },
...
// Converts an ISO 3166-1 alpha-2 code (e.g. "FR") into its flag emoji
// using Unicode regional indicator symbols — no need to store ~240 emoji by hand.
